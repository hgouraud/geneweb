...
val next_utf8 : string -> int -> int
(** returns the index of the character following the n-th character *)

val char : string -> int -> string
(* returns as a string the character starting of the i-th character *)
