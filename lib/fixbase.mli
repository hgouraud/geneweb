...
type patch =
  ...
  | Fix_ChangedSurname of Gwdb.iper
...
val check_children_surname : ?report:(patch -> unit) -> (int -> int -> unit) -> Gwdb.base -> unit

val check_infos_empty_surname : ?report:(patch -> unit) -> (int -> int -> unit) -> Gwdb.base -> unit
