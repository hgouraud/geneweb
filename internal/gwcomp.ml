...
(* Option qui force a cr�� les cl�s des individus. De fait, *)
(* si la cl� est incompl�te, on l'enregistre tout de m�me.  *)
            ...
            let (fevents, line) =
              let rec loop fevents =
                ...
                | x ->
                    ...
                    (* On r�cup�re le nom, date, lieu, source, cause *)
