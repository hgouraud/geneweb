...
let rec print_both_branches conf base info pl1 pl2 =
  if pl1 = [] && pl2 = [] then ()
    ...
    Wserver.wprint "</tr>\n";
    Wserver.wprint "<tr align=\"%s\">\n" conf.left;
    Wserver.wprint "<td valign=\"top\" align=\"center\">\n";
    begin match p1 with
...
let print_two_branches_with_table conf base info =
  Wserver.wprint
    ...
    conf.border;
  Wserver.wprint "<tr align=\"%s\">\n" "left";
  Wserver.wprint "<td colspan=\"3\" align=\"center\">";
  ...
  Wserver.wprint "</tr>\n";
  Wserver.wprint "<tr align=\"%s\">\n" "left";
  Wserver.wprint "<td align=\"%s\">" conf.right;
  Wserver.wprint "<hr class=\"%s\"%s>\n" conf.right conf.xhs;
  Wserver.wprint "</td>\n";
  Wserver.wprint "<td>";
  Wserver.wprint "<hr class=\"full\"%s>\n" conf.xhs;
  Wserver.wprint "</td>\n";
  Wserver.wprint "<td align=\"%s\">" conf.left;
  Wserver.wprint "<hr class=\"%s\"%s>\n" conf.left conf.xhs;
  Wserver.wprint "</td>\n";
  Wserver.wprint "</tr>\n";
...
let print_relation_ok conf base info =
  ...
  Wserver.wprint "<p style=\"clear:both\"%s>\n" conf.xhs;
