...
let lowercase_if_not_utf8 s =
  if !(Mutil.utf_8_db) then s else String.lowercase s
...
let print_alphabetic_big conf base is_surnames ini list len too_big =
  ...
  List.iter
    (fun (ini_k, _) ->
       Wserver.wprint "<a href=\"%sm=%s;tri=A;k=%s\">" (commd conf) mode
    ...
    begin
      ...
      begin
        ...
        begin
          Wserver.wprint "<li>";
          begin
            Wserver.wprint "<a href=\"%sm=%s;tri=A;o=A;k=%s\">" (commd conf)
              mode ini;
        ...
        begin
          Wserver.wprint "<li>";
          begin
            Wserver.wprint "<a href=\"%sm=%s;tri=S;o=A;k=%s\">" (commd conf)
              mode ini;
        ...
        begin
          Wserver.wprint "<li>";
          begin
            Wserver.wprint "<a href=\"%sm=%s;tri=S;o=A;k=%s;cgl=on\">"
              (commd conf) mode ini;
  ...
  if list = [] then ()
    ...
    begin
      ...
      List.iter
        (fun (_, s, cnt) ->
           Wserver.wprint "<li>";
           Wserver.wprint "<a href=\"%sm=%s;v=%s;t=A\">" (commd conf) mode
         ...
         begin
           ...
           begin
             ...
             List.iter
               (fun s ->
                  Wserver.wprint "<li>";
                  Wserver.wprint "<a href=\"%sm=%s;v=%s\">" (commd conf) mode
